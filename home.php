...
<div class="col-lg-3">
 <div class="card colo-md-4" style="width:250px">
  <img class="card-img-top" src="img/home5.jpg" alt="Card image" width="250px;" height="190px;">
  <div class="card-body"><center>
    <h4 class="card-title"><b>Payment</b></h4><br>
    <p class="card-text">This page contains the details of all Payment.</p><br>
    <a href="payment.php" class="btn btn-primary">See Details</a></center><br>
  </div>
</div>
